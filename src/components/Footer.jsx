    ...
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                    <b>Why Not</b> stay on the sand? We are your complete beachfront escape in Wewala, Sri Lanka. Enjoy amazing food, ice cold drinks, comfortable rooms, and thrilling sea adventures all in one spot.
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} wolfsoft. All rights reserved.</p>
