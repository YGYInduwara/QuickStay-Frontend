...
const RoomDetails = () => {
  ...
  useEffect(() => {
    const r = roomsDummyData.find(r => r._id === id);
    if (r) {
      setRoom(r);
  ...
  // normalize hotel phone to WhatsApp format (digits only, no '+')
  const ownerPhone = (room.hotel?.contact || '')
    .replace(/\D/g, ''); // keep digits only e.g. "+94 12 345 6789" -> "94123456789"
